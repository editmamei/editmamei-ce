...
2. **Reproduction steps** — minimal repro, ideally including the MCP client name + version, the OS, the Photoshop version, and the input that triggers it.
...
- **Triage update** within 7 days — confirmed / not-reproduced / needs-more-info.
